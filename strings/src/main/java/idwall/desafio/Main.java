...
import idwall.desafio.file.IdwallFile;
 ...
 * Modified by Manuel Almeida on 12/04/2020
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (args.length) {
            case 1:
                text = IdwallFile.stringFromFile(args[0]);
                break;
            case 2:
                text = IdwallFile.stringFromFile(args[0]);
        ...
        // Run IdwallFormatter
        final StringFormatter resizeFormatter = new IdwallFormatter(limit);
        final StringFormatter justifyFormatter = new IdwallJustify(limit);
        String outputText = justify ?
                justifyFormatter.format(resizeFormatter.format(text)) :
                resizeFormatter.format(text);
